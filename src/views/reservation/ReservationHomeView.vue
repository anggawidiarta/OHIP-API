      ...
      <section class="py-14" id="create-reservation">
        ...
        >
          ...
          <div
            ...
            data-aos-duration="1000"
          >
            <h2 class="font-medium text-white">Select your payment method</h2>
            <form
              @submit.prevent="
            ...
            >
                  ...
                  <label :for="item.name" class="block relative">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p class="mt-1 text-sm capitalize text-gray-600c">
                          {{ item.description }}
                        </p>
                      </div>
                    </div>
              ...
              <div class="flex justify-end items-center">
                <Button
                  type="submit"
                  class="md:w-[125px] w-full mt-3 text-white tracking-wide bg-teal-600 hover:bg-teal-700"
                  >Submit</Button
                >
              </div>
            </form>
