<template>
  <footer class="text-foreground bg-background px-4 py-5 lg:px-6">
    ...
    >
      <li v-for="item in footerNavs" :key="item.id" class="hover:text-primary">
        <a :href="item.href">
          {{ item.name }}
        </a>
      </li>
    ...
    <div class="mt-8 items-center justify-between sm:flex">
      <div class="mt-4 sm:mt-0">
        &copy; {{ new Date().getFullYear() }} Oxindo Solution All rights
        reserved.
      </div>
